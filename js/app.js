...
/*
  ...
  CDN 読み込み失敗時も既存機能に影響しないよう typeof チェック済み。
  ========================================================
*/
if (typeof maplibreGlExport !== 'undefined') {
  map.addControl(
    new maplibreGlExport.MaplibreExportControl({
      PageSize:        maplibreGlExport.Size.A4,
      PageOrientation: maplibreGlExport.PageOrientation.Landscape,
      Format:          maplibreGlExport.Format.PNG,
      DPI:             maplibreGlExport.DPI[96],
      Crosshair:       true,
      PrintableArea:   true,
      Local:           'ja',
    }),
